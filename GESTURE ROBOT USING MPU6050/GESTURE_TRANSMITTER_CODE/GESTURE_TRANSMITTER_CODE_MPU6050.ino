...
void loop() {
  ...
  String roll,pitch;
   ...
   LoopTimer=micros();
   float rpitch[2];
   rpitch[0] = KalmanAngleRoll;
   rpitch[1] = KalmanAnglePitch;
   /*send_data.roll = KalmanAngleRoll;
   send_data.pitch = KalmanAnglePitch;
   Serial.println(send_data.pitch);
   Serial.println(send_data.roll);*/
   Serial.println(rpitch[0]);
   Serial.println(rpitch[1]);
   radio.write(&rpitch, sizeof(rpitch));
   Serial.println("Sent");
}
